...
describe('complex()', function() {
  ...
  describe('add()', function() {
    it('should add the given complex Numbers', function() {
      ...
      const resultantComplexNumber = firstComplexNumber.add(secondComplexNumber);
      const actual = {real: resultantComplexNumber.getRealPart(), imaginary: resultantComplexNumber.getImaginaryPart()}
  ...
  describe('multiply()', function() {
    it('should multiply the given complex Numbers', function() {
      ...
      const secondComplexNumber = complexNumber(4, -5);
      const resultantComplexNumber = firstComplexNumber.multiply(secondComplexNumber);
      const actual = {real: resultantComplexNumber.getRealPart(), imaginary: resultantComplexNumber.getImaginaryPart()}
